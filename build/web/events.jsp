  ...
  <span class="tooltiptext"><c:out value="${row.des}"/></span>
    ...
    <td><c:out value="${row.dt}"/></td>
              ...
              <div class="otherevents">
                  ...
                  <sql:query dataSource="${db}" var="rs">  
                   SELECT * from events where company <>'<%  out.print(String.valueOf(session.getAttribute("name"))); %>' ORDER BY dt;  
                   </sql:query> 
                   if u want decending order <a href="events1.jsp"> click here</a>
                   <table style="width:100%">
